...
public class StudentDAO {
    ...
    public ArrayList<Student> getAllStudents() throws SQLException, NamingException, ClassNotFoundException {
     ...
     */
    public boolean deleteStudent(int studentId) throws SQLException, NamingException, ClassNotFoundException {
    ...
    public boolean updateStudent(Student student) throws SQLException, NamingException, ClassNotFoundException {
